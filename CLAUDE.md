...
**Status:** Phase 9 done — Amazon Integration: CSV Import (ADR-014, `HEXAGARE_FEATURES.md`
...
Previously: Phase 8 — Billing: Payment/Invoice + POS Flow (ADR-013, `HEXAGARE_FEATURES.md`
